...
export default function FeaturedProject({
    ...
    return (
        <article className="grid-rows-[repeat(10,_minmax(0,_1fr)] group mb-36 grid grid-cols-10 last:mb-0 md:mb-40 lg:mb-64 lg:grid-cols-12 lg:grid-rows-4 lg:items-start">
            ...
            <div className="relative col-span-full row-start-2 row-end-[7] overflow-hidden rounded-2xl shadow-md shadow-gray-900/10 lg:col-start-5 lg:col-end-13 lg:row-start-1 lg:shadow-xl lg:group-even:col-start-1 lg:group-even:col-end-9 2xl:col-start-5 2xl:col-end-12 2xl:group-even:col-start-2">

                    ...
                    {technologies.map((tech) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                />
                                <span className="absolute top-full left-1/2 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap text-[9px] text-purple-600 opacity-0 transition-all group-hover/img:translate-y-full group-hover/img:opacity-100 xs:text-[10px] xl:text-xs 2xl:text-sm">
                                    {tech.title}
                                </span>
                            </motion.div>
                        );
